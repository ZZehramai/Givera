...
export default function LanguageSwitch({ compact = false, inverse = false }) {
  ...
  return <div className={`inline-flex items-center rounded-xl border p-1 ${inverse ? "border-white/20 bg-white/10" : "border-slate-200 bg-slate-50"}`} aria-label="Language">
