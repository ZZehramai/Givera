...
function RecommendationsPanel({ recommendations, loading, onBrowse }) {
  ...
  return (
    <section className="mt-6 rounded-[28px] border border-[#DDD4F7] bg-white p-6 shadow-[0_12px_30px_rgba(43,37,80,.06)]">
      ...
      {loading ? (
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {recommendations.slice(0, 3).map((campaign) => (
            <div key={campaign.id} className="rounded-2xl border border-slate-100 bg-[#FCFBFE] p-3">
