  ...
  return (
    <div className="min-h-screen bg-surface text-on-surface">
      ...
      <main>
        ...
        {/* HOW IT WORKS SECTION (RESIZED FOR SCREEN PROPORTION) */}
        <section
          id="how-it-works"
          className="scroll-mt-20 bg-white py-16 md:py-24 flex items-center justify-center overflow-hidden"
        >
          <div className="mx-auto max-w-5xl px-6 w-full">
            
            {/* Header */}
            <div className="mx-auto max-w-2xl text-center">
              <p className="text-xs md:text-sm font-bold uppercase tracking-[0.16em] text-primary">
                The donor journey
              </p>
              <h2 className="mt-2 text-2xl sm:text-3xl md:text-4xl font-extrabold text-on-surface">
                Three simple steps to give with confidence
              </h2>
              <p className="mx-auto mt-3 text-sm md:text-base text-on-surface-variant max-w-xl leading-relaxed">
            ...
            <div className="mx-auto mt-8 md:mt-12 max-w-4xl">
              <div className="relative aspect-[1000/220] w-full">
                ...
                >
                  <motion.path
                    d="M20,150 C90,150 110,130 150,120 C230,100 320,50 430,50 C520,50 600,100 690,100 C780,100 880,50 970,30"
                ...
                {donorJourneySteps.map((step, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="grid h-12 w-12 md:h-14 md:w-14 place-items-center rounded-2xl border border-outline-variant/50 bg-white text-primary shadow-lg shadow-primary/15">
              ...
              <div className="mt-6 grid gap-6 sm:grid-cols-3">
                {donorJourneySteps.map((step, index) => (
                  ...
                  >
                    ...
                    <h3 className="mt-1 text-base md:text-lg font-bold text-on-surface">{step.title}</h3>
            ...
            <div className="mt-10 md:mt-12 text-center">
              <motion.div className="inline-block" whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
                <Link
                  to="/campaigns"
                  className="inline-flex items-center gap-2 rounded-full bg-primary px-7 py-3.5 text-sm font-bold text-white shadow-lg shadow-primary/20 transition hover:-translate-y-0.5"
                >
